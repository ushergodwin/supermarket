...
//alter these settings where necessary
define("HOST", $db->default['hostname']);
define("USERNAME", $db->default['username']);
define("PASSWORD", $db->default['password']);
define("DB", $db->default['database']);
...
class BL_DbModel
{
     ...
     */
    public function __construct(string $database = DB, string $time_zone = 'Africa/Kampala') {
