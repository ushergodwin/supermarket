<header class="header-top">
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="#"><img class="svg dark" src="{{assets('img/Logo_Dark.svg') }}" alt="">
                <img class="light" src="{{assets('img/Logo_white.png') }} " alt="">
            </a>
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                    ...
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                            <ul class="list-settings">
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/mail.png') }}" alt=""></div>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/color-palette.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/home.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/video-camera.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/document.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{assets('img/microphone.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                ...
                <li class="nav-flag-select">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{assets('img/flag.png') }}" alt=""
                                                                            class="rounded-circle"></a>
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href=""><img src="{{assets('img/ger.png') }}" alt=""> German</a>
                            <a href=""><img src="{{assets('img/spa.png') }}" alt=""> Spanish</a>
                            <a href=""><img src="{{assets('img/tur.png') }}" alt=""> Turkish</a>
                            <a href=""><img src="{{assets('img/eng.png') }}" alt=""> English</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{assets('img/author-nav.jpg') }}"
                                                                            alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper">
                            <div class="nav-author__info">
                                <div class="author-img">
                                    <img src="{{assets('img/author-nav.jpg') }}" alt="" class="rounded-circle">
                                </div>
                                <div>
