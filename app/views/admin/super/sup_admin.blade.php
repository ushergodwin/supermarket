            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Supermarket Admins</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-horizontal card-default card-md mb-4">
                        <div class="row mt-5 mr-2 ml-2">
                            ...
                            <div class="col-md-10">
                                <input type="search" id="search" class="form-control" placeholder="search supermarket admins"
                                    ...
                                    <tbody>
                                        @foreach ($users as $item)
                                            ...
                                            <td>
                                                ...
                                                {{-- <td>
                                                    <a href="{{ url('users/supermarket-admin/'.$item->id) }}" title="view more details of {{ $item->fname . " ".$item->lname }}" class="view"><span data-feather="eye"></span> </a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('users/supermarket-admin/'.$item->id . '/edit') }}" title="edit details of {{ $item->fname . " ".$item->lname }}"><i class="fas fa-pen-square text-primary"></i> </a>
                                                </td> --}}
                                                <td>
