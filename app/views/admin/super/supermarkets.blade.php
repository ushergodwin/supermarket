                                ...
                                <table class="table table-bordered table-striped" id="patientTable">
                                    ...
                                    <tbody>
                                        @foreach ($collection as $item)
                                            ...
                                            <td><a href="{{ url('supermarkets/'.$item->id) }}" title="view more details of {{ $item->name }}" data-toggle="tooltip" class="view"><span data-feather="eye"></span> </a></td>
                                            <td><a href="{{ url('supermarkets/'.$item->id . '/edit') }}" title="edit details of {{ $item->name }}" data-toggle="tooltip"><i class="fas fa-pen-square text-primary"></i> </a></td>
                                            <td><a href="javascript:void(0)" data-url="{{ url('supermarket/'.$item->id) }}" data-resource-id="{{$item->id}}" title="Delete {{ $item->name }}?" data-toggle="tooltip" class="delete-resource-btn" ><i class="fas fa-trash-alt text-danger"></i> </a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
