                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-horizontal card-default card-md mb-4">
                        <div class="card-body py-md-30">
                            <form action="<?php echo e(url('supermarket-items/store')); ?>" method="post" id="supermarketItemForm" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e(old('category')); ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            <label for="column_number">Item Column Number</label>
                                            <input type="number" name="column_number" value="<?php echo e(old('column_number')); ?>"  class="form-control" required/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select name="position" class="form-control"required>
                                                ...
                                                <option value="middle-left" <?php echo e(old('position') == 'middle-left' ? "selected" : ""); ?>>MIDDLE LEFT</option>
                                                ...
                                                <option value="middle-right" <?php echo e(old('position') == 'middle-right' ? "selected" : ""); ?>>MIDDLE RIGHT</option>
...
<?php echo $__env->make('partials.admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\supermarket\app\views/admin/supermarket/add_items.blade.php ENDPATH**/ ?>