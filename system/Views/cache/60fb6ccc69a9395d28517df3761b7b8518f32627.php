    ...
    <section class="contents">
        <section class="container-fluid">
            <div class="row mt-2">
                ...
                <div class="col-lg-8">
                    <h5><u>Search results for <?php echo e(strtoupper($category)); ?> IN <?php echo e($supermarket); ?> </u></h5>
                    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.user.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\supermarket\app\views/user/supermarket_item_search.blade.php ENDPATH**/ ?>